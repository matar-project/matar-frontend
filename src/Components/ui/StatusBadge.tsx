...
const statusMap: Record<string, { label: string; className: string }> = {
  ...
  PENDING_COORDINATOR: { label: 'بانتظار الموزع', className: 'bg-blue-100 text-blue-800' },
  COORDINATOR_ACCEPTED: { label: 'مقبول', className: 'bg-green-100 text-green-800' },
  ...
  DONE: { label: 'تم', className: 'bg-green-100 text-green-800' },
